...
const EditProducts = ({ onSave, onDelete }) => {
    ...
    const currentCategory =
        categories.find((cat) => cat.id === Number(editProduct.productCategoryId))?.name || "No Category";
                ...
                {isEditing && (
                    <div className="flex gap-2 mb-2">
                        <input
                            type="text"
                            value={newAttr.key}
                            onChange={e => setNewAttr(attr => ({ ...attr, key: e.target.value }))}
                        ...
                        <input
                            type="text"
                            value={newAttr.value}
                            onChange={e => setNewAttr(attr => ({ ...attr, value: e.target.value }))}
            ...
            <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                    {(isEditing
                        ...
                        : editProduct.contents.filter(c => c.type?.toLowerCase() === "image") // Only images in view mode
                    ).map((content, idx) => (
                        <div
                            key={idx}
